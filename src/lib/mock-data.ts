...
export const quickActions: QuickAction[] = [
  ...
  { id: "word-to-pdf", label: "Word to PDF", description: "DOCX → PDF instantly", icon: "FileText", href: "/convert?from=docx&to=pdf", colorFrom: "#5B7FFF", colorTo: "#3D9BFF" },
  { id: "excel-to-pdf", label: "Excel to PDF", description: "XLSX → PDF instantly", icon: "Sheet", href: "/convert?from=xlsx&to=pdf", colorFrom: "#22C55E", colorTo: "#5B7FFF" },
  { id: "ppt-to-pdf", label: "PowerPoint to PDF", description: "PPTX → PDF instantly", icon: "MonitorPlay", href: "/convert?from=pptx&to=pdf", colorFrom: "#F59E0B", colorTo: "#EF4444" },
  { id: "image-to-pdf", label: "Image to PDF", description: "JPG / PNG → PDF", icon: "Image", href: "/convert?from=image&to=pdf", colorFrom: "#7C5CFF", colorTo: "#36CFC9" },
  { id: "pdf-to-word", label: "PDF to Word", description: "PDF → editable DOCX", icon: "FileEdit", href: "/convert?from=pdf&to=docx", colorFrom: "#5B7FFF", colorTo: "#7C5CFF" },
  ...
  { id: "pdf-to-image", label: "PDF to Image", description: "Export pages as PNG/JPG", icon: "ImageDown", href: "/convert?from=pdf&to=image", colorFrom: "#F59E0B", colorTo: "#7C5CFF" },
