        ...
        return (
          ...
          >
            <Link
              ...
              className="group relative flex h-full flex-col gap-3 overflow-hidden rounded-2xl border border-border/70 bg-card p-4 card-elevated outline-none transition-shadow hover:card-elevated-lg focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:p-5"
            >
              <div
                aria-hidden="true"
